...
The organization will host several repositories as the project takes shape:

- **Core runtime** — the Rust orchestrator, plugin host, and device model.
- **Plugin SDKs** — language-specific helpers for building WASM plugins (Rust first; bindings for others to follow).
- **Plugins** — first-party integrations for common devices and protocols.
- **Docs & articles** — design notes, architecture decisions, and tutorials.

## License

Code in this organization is released under your choice of [MIT](https://opensource.org/license/mit) or [Apache-2.0](https://opensource.org/license/apache-2-0), the standard dual-license used across the Rust ecosystem.

Articles, documentation, and other written content are released under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/).

Each repository will declare its own license; these are the defaults.
